defmodule LiveFeedbackWeb.MessageLiveTest do
  use LiveFeedbackWeb.ConnCase

  import Phoenix.LiveViewTest
  import LiveFeedback.MessagesFixtures

  @create_attrs %{content: "some content", is_anonymous: true, anonymous_id: "some anonymous_id", is_answered: true}
  @update_attrs %{content: "some updated content", is_anonymous: false, anonymous_id: "some updated anonymous_id", is_answered: false}
  @invalid_attrs %{content: nil, is_anonymous: false, anonymous_id: nil, is_answered: false}
