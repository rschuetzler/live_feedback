defmodule LiveFeedbackWeb.MessageLive.FormComponent do
  ...
  def render(assigns) do
    ...
    <div>
      ...
      >
        ...
        <.input field={@form[:is_anonymous]} type="checkbox" label="Is anonymous" />
        <.input field={@form[:anonymous_id]} type="text" label="Anonymous" />
        <.input field={@form[:is_answered]} type="checkbox" label="Is answered" />
        <:actions>
